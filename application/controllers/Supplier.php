...
//------------------------------------------------------------------------------------------
	...
	{
		$produk = $this->supmodel->GetProduk("where id_produk = '$id_produk'");
		$data = array(
	...
	public function do_edit_produk()
	{
		...
		$data = array('id_produk'=>$id_produk,'kategori'=>$kategori,'produk'=>$produk,'satuan'=>$satuan,'harga_jual'=>$harga_jual);
