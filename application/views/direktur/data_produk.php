                            ...
                            <table class="table mb-0" id = "rupiah">
                                <thead class="thead-dark">
                                    ...
                                    <tr>
                                        ...
                                        <td> <a iframe type="application/pdf" href="<?php echo base_url() . 'assets/assets/images/' . $d['file_desk']; ?>" width="600" height="400"><?php echo $d['file_desk'] ?></a>
                                        <a href="<?php echo base_url() . 'assets/assets/images/' . $d['file_desk']; ?>" download><i class="fas fa-fw fa-download"></i></a>
                                        </td>
                                        <td><center>
                                        <?php
