                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="settings_detail_tab" data-toggle="pill" href="">Selesai</a>
                                            </li>
                                        </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0" id = "rupiah">
                                ...
                                <tr>
                                    ...
                                    <td><center>
                                        <a href="<?php echo base_url()."index.php/Admin/do_edit_kemas/".$d['id_pelanggan'];?>" ><span class="btn btn-sm btn-danger rounded-pill waves-effect waves-light">Kemas</span></a>
