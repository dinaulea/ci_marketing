                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <ul class="nav nav-pills mb-0" id="pills-tab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="general_detail_tab" data-toggle="pill" href="<?php echo base_url()."index.php/Admin/status_produkadm";?>">Order</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="activity_detail_tab" data-toggle="pill" href="<?php echo base_url()."index.php/Admin/status_kemas";?>">Dikemas</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="portfolio_detail_tab" data-toggle="pill" href="<?php echo base_url()."index.php/Admin/status_kirim";?>">Dikirim</a>
                                            </li>
                                            <li class="nav-item">
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0" id = "rupiah">
                                ...
                                <tr>
                                    ...
                                    <td><img src ="<?php echo base_url().'assets/assets/images/'.$d['foto_bukti']; ?>" height="100px" width="100px">
                                        <br><a href="<?php echo base_url().'assets/assets/images/'.$d['foto_bukti']; ?>" download><i class="icon-trash"></i>&nbsp; Download</a></br>
                                    </td>
                                    <td>
                                    <?php
                                        if ($d ['status']=='Produk Dikemas'){
                                            echo "<span class='badge bg-warning'>Produk Dikemas</span>";
                                        } elseif ($d ['status']=='Produk Dikirim'){
                                            echo "<span class='badge bg-success'>Produk Dikirim</span>";
                                        }
                                         else {
                                            echo "<span class='badge bg-danger'>Produk Sampai</span>";
                                        } 
                                    ?>
                                    </td>
                                    <td><img src ="<?php echo base_url().'assets/assets/images/'.$d['bukti_selesai']; ?>" height="100px" width="100px">
                                        <br><a href="<?php echo base_url().'assets/assets/images/'.$d['bukti_selesai']; ?>" download><i class="icon-trash"></i>&nbsp; Download</a></br>
                                    </td>
                                    <td><center>
                                        <a href="<?php echo base_url()."index.php/Admin/do_edit_kemas/".$d['id_pelanggan'];?>"><span class="btn btn-sm btn-info rounded-pill waves-effect waves-light">Kemas</span></a>
