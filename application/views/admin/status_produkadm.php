                            ...
                            <table class="table mb-0" id = "rupiah">
                                ...
                                <tr>
                                    ...
                                    <?php
                                        if ($d ['status']==''){
                                            echo "";
                                        } elseif ($d ['status']=='Produk Dikemas'){
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            <br><a href="<?php echo base_url().'assets/file_bukti/'.$d['bukti_selesai']; ?>" download><i class="icon-trash"></i>&nbsp; Download</a></br>
                                        <?php  } ?>
