                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <ul class="nav nav-pills mb-0" id="pills-tab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link active" id="activity_detail_tab" data-toggle="pill" href="<?php echo base_url()."index.php/Admin/status_kemas";?>">Dikemas</a>
                                            </li>
                                            <li class="nav-item">
                    ...
                    <div class="card-header">
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0" id = "rupiah">
                                ...
                                <?php $no = 1; foreach ($data_kemas->result_array() as $d) {?>
                                <tbody>
                                <tr>
                                    <td><?php echo $no++; ?></td>
                                    ...
                                    <td><center>
                                        <a href="<?php echo base_url()."index.php/Admin/do_edit_kirim/".$d['id_pelanggan'];?>" ><span class="btn btn-sm btn-success rounded-pill waves-effect waves-light">Kirim</span></a>
