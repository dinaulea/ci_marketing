            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="<?php echo base_url()."index.php/Admin/do_edit_supplier";?>" method="post" class="form form-horizontal">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="kategori" class="form-control" name="id_supplier" value="<?php echo $id_supplier; ?>"
                                                readonly>
                                        </div>
