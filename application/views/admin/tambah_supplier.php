            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="<?php echo base_url()."index.php/Admin/do_tambah_supplier";?>" method="post" class="form form-horizontal">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label>ID</label>
                                        ...
                                        <input type="text" class="form-control" id="" placeholder="" name="id_supplier" readonly="" value="<?php
                                        $this->db->order_by('id_supplier','desc');
                                        $kode = $this->db->get('supplier')->row()->id_supplier;
                                        $kode_baru = "SUP".(substr($kode, 3, strlen($kode)-3) + 1);
                                        echo $kode_baru;
                                        ?>">  
                                        </div>
