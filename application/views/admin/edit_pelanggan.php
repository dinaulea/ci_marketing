                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="" class="form-control" name="id_pelanggan" value="<?php echo $id_pelanggan; ?>"
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="" class="form-control" name="username" value="<?php echo $username; ?>"
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="" class="form-control" name="password" value="<?php echo $password; ?>"
                                        ...
                                        <div class="col-md-8 form-group">
                                            ...
                                            <input type="text" id="" class="form-control" name="nama" value="<?php echo $nama; ?>"
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="" class="form-control" name="alamat" value="<?php echo $alamat; ?>"
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="" class="form-control" name="nomor_hp" value="<?php echo $nomor_hp; ?>"
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="" class="form-control" name="email" value="<?php echo $email; ?>"
                                                placeholder="Nomor HP">
                                        </div>
                                        <div class="col-md-4">
