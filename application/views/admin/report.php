            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Kirim Data Melalui Email</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form action="<?php echo base_url()."index.php/Admin/do_tambah_report";?>"  method="post" enctype="multipart/form-data" class="form form-horizontal">
                                <div class="form-body">
                                    <div class="row">
<?php foreach ($report as $d) { ?>
                                    <input type="hidden" class="form-control" name="no_invoice" value="<?= $d['no_invoice'] ?>"
                                                placeholder="Produk">
                                                <?php } ?>
