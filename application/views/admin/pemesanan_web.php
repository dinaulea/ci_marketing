                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <ul class="nav nav-pills mb-0" id="pills-tab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="general_detail_tab" data-toggle="pill" href="<?php echo base_url()."index.php/Admin/pemesanan_web";?>">Order</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="settings_detail_tab" data-toggle="pill" href="<?php echo base_url()."index.php/Admin/pemesanan_selesai";?>">Selesai</a>
                                            </li>
                                        </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0" id = "rupiah">
                                ...
                                <tr>
                                    ...
                                    <td><a iframe type="application/pdf" href="<?php echo base_url() . 'assets/assets/dokumen/' . $d['manual_book']; ?>" width="600" height="400"><?php echo $d['manual_book'] ?></a></td>
                                    <td><center>
                                        <?php
                                        if ($d ['status']=='Revisi'){
