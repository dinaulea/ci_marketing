                    ...
                    <div class="card-content">
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0" id = "">
                                ...
                                <?php $no = 1; foreach ($produksup->result_array() as $d) {?>
                                <tbody>
                                <tr>
                                    <td><?php echo $no++; ?></td>
                                    <td><?php echo $d['kategori'] ?></td>
                                    <td><?php echo $d['produk'] ?></td>
                                    <td><img src="<?php echo base_url() . 'assets/file_produksup/' . $d['foto_produk']; ?>" height="100px" width="100px"></td>
                                    ...
                                    -->
                                    <td><center>
                                    <form action="<?php echo base_url()."index.php/Admin/do_tambah_pembelian";?>" method="post" class="form form-horizontal">
                                    <div class="col-md-4 form-group">
                                    <input type="hidden" id="" class="form-control" name="id_produk" value="<?php echo $d['id_produk'] ?>"
                                                placeholder="Jumlah Pembelian" >
                                    <input type="hidden" id="" class="form-control" name="id_supplier" value="<?php echo $d['id_supplier'] ?>"
                                                placeholder="Jumlah Pembelian" >
                                    <input type="hidden" id="" class="form-control" name="produk" value="<?php echo $d['produk'] ?>"
                                    placeholder="Jumlah Pembelian" >
                                            <input type="text" id="" class="form-control" name="jumlah"
                                                placeholder="Jumlah Pembelian" >
                                        </div>
                                    </center>
                                    </td>
