            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="<?php echo base_url()."index.php/Admin/do_edit_produk";?>" enctype="multipart/form-data" method="post" class="form form-horizontal">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="" class="form-control" name="harga_dasar" value="<?php echo $harga_dasar; ?>"
                                        ...
                                        <div class="col-md-4">
                                            <label>File Deskripsi</label>
                                        </div>
                                        <div class="col-md-8 form-group">
                                            <input type="file" id="" class="form-control" name="file_desk" value="<?php echo $file_desk; ?>"
                                                placeholder="">
                                        </div>
