            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="<?php echo base_url()."index.php/Admin/do_edit_web";?>" method="post" class="form form-horizontal">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="kategori" class="form-control" name="url_web" value="<?php echo $url_web; ?>"
                                                placeholder="URL Website">
                                            <!-- <input type="file" id="" class="form-control" name="url_web"
                                                placeholder=""> -->
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="file" id="" class="form-control" name="manual_book"
                                                placeholder="">
                                        </div>
