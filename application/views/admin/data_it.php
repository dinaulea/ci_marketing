                        ...
                        <div class="table-responsive">
                            <table class="table mb-0" id = "rupiah">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $d['jenis_sistem'] ?></td>
                                    <td><?php echo $d['desk_sistem'] ?></td>
                                    <td><?php echo $d['qty'] ?></td>
                                    <td><?php echo rupiah($d['uang_muka']) ?></td>
                                    <td><?php echo rupiah($d['price'])?></td>
                                    <td><a href="<?php echo base_url()."index.php/Admin/print_surat_it/".$d['no_invoice'];?>">Print Surat</a></td>
                                    <td>
                                        <a href="<?php echo base_url()."index.php/Admin/edit_invoice_it/".$d['no_invoice'];?>" onClick="return confirm('Apakah Anda ingin mengedit data?');"><span class="fa-fw select-all fas"></span></a> 
                                        <a href="<?php echo base_url()."index.php/Admin/hapus_invoice/".$d['no_invoice'];?>" onClick="return confirm('Apakah Anda ingin menghapus data Invoice ini?');"><span class="fa-fw select-all fas"></span></a> 
                                        <p><a href="<?php echo base_url()."index.php/Admin/print_invoice_it/".$d['no_invoice'];?>" onClick="return confirm('Apakah Anda ingin mencetak data?');"><i class="icon-trash"><span class="fa-fw select-all fas"></span></a>
                                        <a href="#"><span class="fa-fw select-all fas"></span></a></p> 
                                    </td>
                                    <td></td>
                                </tr>
                                <?php
