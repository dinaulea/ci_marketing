                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form action="<?php echo base_url()."index.php/Admin/do_input_invoice1";?>" method="post" class="form form-horizontal">
                                <div class="form-body">
                                    <div class="row">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <select class="form-control" id="nama" name="nama_pelanggan[]">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-8 form-group">
                                                <input type="text" id="" class="form-control" name="kategori[]" value="Non IT" readonly>  
                                            </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <select class="form-control" name="produk[]">
                                                    <?php foreach($idproduk as $l){ ?>
                                                    <option value="<?php echo $l['produk']; ?>"><?php echo $l['produk']; ?> </option>
                                                    <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 form-group">
                                            <button type="button" id="btn-tambah-form"  class="btn btn-primary mr-1">Tambah Data</button>
                                            <div id="insert-form">
                                            </div>     
                                        </div>
                                    </div>
                    ...
                    $("#nama").change(function(){
                        ...
                        $.ajax({
                            ...
                            success: function(result){
                                ...
                                console.log("tes id",id_pelanggan);
