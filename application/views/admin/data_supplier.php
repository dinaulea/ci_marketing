                        ...
                        <div class="table-responsive">
                            <table class="table mb-0" id = "rupiah">
                                ...
                                <tr>
                                    ...
                                    <td><center>
                                        <a href="<?php echo base_url()."index.php/Admin/edit_supplier/".$d['id_supplier'];?>" ><span class="btn btn-sm btn-warning rounded-pill waves-effect waves-light">Edit</span></a>
                                        <a href="<?php echo $linkWA ?>" target="_blank"><span class="btn btn-sm btn-info rounded-pill waves-effect waves-light">Kirim Akun</span></a>
                                        <a href="<?php echo base_url()."index.php/Admin/hapus_supplier/".$d['id_supplier'];?>" ><span class="btn btn-sm btn-danger rounded-pill waves-effect waves-light">Hapus</span></a>
                                        </center>
                                    </td>
                                </tr>
                                <?php
