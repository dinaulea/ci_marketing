            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                        <a href="<?php echo base_url()."index.php/Admin/tambah_supplier";?>" class="btn btn-primary rounded-pill">Tambah Supplier</a>
                        </div>
                        <!-- table head dark -->
                        <div class="table-responsive">
                            <table class="table mb-0" id = "rupiah">
                                ...
                                <tr>
                                    ...
                                    <td><center>
                                        <a href="<?php echo $linkWA ?>" ><span class="btn btn-sm btn-info rounded-pill waves-effect waves-light">Kirim Akun</span></a>
