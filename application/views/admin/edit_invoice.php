            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="<?php echo base_url()."index.php/Admin/do_edit_invoice";?>" method="post" class="form form-horizontal">
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 form-group">
                                                <select class="form-control" name="produk">
                                                    <?php            
                                                    $q = $this->db->query("select *from produklayanan"); 
                                                    $result = $q->result();         
                                                    foreach($result as $row){ ?>   
                                                    <option value="<?php echo $row->produk;?>" <?php if($row->produk==$produk){ echo 'selected';} ?>><?php echo $row->produk;?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
