                    ...
                    <div class="card-content">
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0" id = "rupiah">
                                ...
                                <?php  $no = 1; foreach ($data_nonit->result_array() as $d) {?>
                                <tbody>
                                <tr>
                                    <td><?php echo $no++; ?></td>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url()."index.php/Admin/edit_invoice/".$d['no_invoice'];?>" onClick="return confirm('Apakah Anda ingin mengedit data?');"><span class="fa-fw select-all fas"></span></a> 
                                        ...
                                        <p><a href="<?php echo base_url()."index.php/Admin/print_invoice/".$d['no_invoice'];?>" onClick="return confirm('Apakah Anda ingin mencetak data?');"><i class="icon-trash"><span class="fa-fw select-all fas"></span></a>
