                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link active" id="settings_detail_tab" data-toggle="pill" href="<?php echo base_url()."index.php/Admin/status_selesai";?>">Selesai</a>
                                            </li>
                                        </ul>
                                        </div>
                                    </div>
                    ...
                    <div class="card-header">
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0" id = "rupiah">
                                ...
                                <?php $no = 1; foreach ($data_selesai->result_array() as $d) {?>
                                <tbody>
                                <tr>
                                    <td><?php echo $no++; ?></td>
