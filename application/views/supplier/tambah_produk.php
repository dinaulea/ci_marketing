...
<head>
    ...
    <title>Tambah Data Produk Supplier</title>
            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Tambah Data Produk Supplier</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            
                            <form action="<?php echo base_url()."index.php/Supplier/do_tambah_produk";?>" method="post" enctype="multipart/form-data" class="form form-horizontal">
                                <div class="form-body">
                                    <div class="row">
                                    <input type="text" id="" class="form-control" name="id_produk" hidden>
                                    <input type="text" id="" class="form-control" name="id_supplier" value="" hidden>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="file" id="produk" class="form-control" name="foto_produk"
                                                placeholder="Produk">
                                        </div>
                                        <div class="col-md-4">
                                            <label>Satuan</label>
