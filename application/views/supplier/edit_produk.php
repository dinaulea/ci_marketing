...
<head>
    ...
    <title>Edit Data Produk Supplier</title>
            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edit Data Produk Supplier</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form action="<?php echo base_url()."index.php/Supplier/do_edit_produk";?>" method="post" enctype="multipart/form-data" class="form form-horizontal">
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="file" id="produk" class="form-control" name="foto_produk" value="<?php echo $foto_produk; ?>"
                                                placeholder="Produk">
                                        </div>
                                        <div class="col-md-4">
                                            <label>Satuan</label>
