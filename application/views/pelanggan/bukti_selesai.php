            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="<?php echo base_url()."index.php/Pelanggan/do_edit_bukti_selesai";?>" method="post" enctype="multipart/form-data" class="form form-horizontal">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8 form-group">
                                            ...
                                            <input type="text" id="" class="form-control" name="nama_lengkap" value="<?php echo $nama_lengkap; ?>"
                                                placeholder="Nama Lengkap" readonly>
                                        </div>
                                        <div class="col-md-4">
                                            <label>Unggah Bukti Selesai</label>
                                        </div>
                                        <div class="col-md-8 form-group">
